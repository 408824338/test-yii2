...
<?php } ?>
    ...
    <?php echo Html::hiddenInput('order_id', $_GET['id']) ?>

    
<?php // Html::a('确认发货', ['order/confirm','id'=>$_GET['id']], ['class' => 'button_submit', 'data-confirm' => '确认已发货？']) ?>
    <?php 
    if($is_fahuo == 1){
       echo    Html::submitButton('已经发货', ['class' => 'button_submit','disabled'=>true]);
    }else{
      echo    Html::submitButton('确认发货', ['class' => 'button_submit']);
    }
    ?>
<?php ActiveForm::end(); ?>
</div>
