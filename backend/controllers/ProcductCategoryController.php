 ...
 */
class ProcductCategoryController extends Controller {
    ...
    public function actionIndex() {
        $searchModel = new ProcductCategorySearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $ProcductCategory = new ProcductCategory;
        $catetory_list = $ProcductCategory->getOptions();

        return $this->render('index', [
                    'searchModel' => $searchModel,
                    'dataProvider' => $dataProvider,
                    'catetory_list' => $catetory_list,
        ]);
    }
